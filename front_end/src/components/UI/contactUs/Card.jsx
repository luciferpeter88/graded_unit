...
function Card({ name, contact, icon }) {
  return (
    <div className=" px-5 h-40 lg:h-52 w-96 bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700  drop-shadow-lg flex flex-col justify-around ">
